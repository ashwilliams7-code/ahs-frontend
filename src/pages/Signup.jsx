...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-accent-600 via-emerald-600 to-teal-700 p-12 flex-col justify-between relative overflow-hidden">
        {/* Background elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-24 -right-24 w-96 h-96 bg-white/10 rounded-full blur-3xl"></div>
          <div className="absolute -bottom-24 -left-24 w-80 h-80 bg-primary-500/20 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="relative">
          <h2 className="text-4xl font-bold text-white mb-4">
            Join the Future of NDIS Management
          </h2>
          ...
          <div className="mt-8 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-white">Automated NDIS invoice generation</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-white">Smart shift scheduling & rostering</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-white">Real-time compliance monitoring</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          <p className="text-emerald-100 text-sm">
            Trusted by 200+ NDIS providers across Australia
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
                placeholder="Your NDIS Provider Name"
              />
            </div>
